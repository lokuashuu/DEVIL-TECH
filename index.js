...
const port = process.env.PORT || 9090;
  ...
  let up = `*Hello there DEVIL-TECH User! \ud83d\udc4b\ud83c\udffb* \n\n> Simple , Straight Forward But Loaded With Features \ud83c\udf8a, Meet DEVIL-TECH WhatsApp Bot.\n\n *Thanks for using DEVIL-TECH \ud83d\udea9* \n\n> Join WhatsApp Channel :- ⤵️\n \nhttps://whatsapp.com/channel/0029Vb4HJcD4inowFiwWsY1S\n\n- *YOUR PREFIX:* = ${prefix}\n\nDont forget to give star to repo ⬇️\n\nhttps://github.com/lokuashuu/DEVIL-TECH\n\n> © Powered BY ᴄʏʙᴇʀ ʟᴏᴋᴜ ᴀꜱʜᴜᴜ \ud83d\udda4`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/qeo9im.jpg` }, caption: up })
  }
  })
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('94760091093', '94755094006', '94777899089');
...
if (!isReact && senderNumber === botNumber) {
  ...
  app.get("/", (req, res) => {
  res.send("DEVIL-TECH MD V1.0 WHATSAPP BOT STARTED ✅");
  });
